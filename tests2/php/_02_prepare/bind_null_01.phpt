...
$sql = <<<EOD
CREATE TABLE prepare_tb(c1 string, c2 char(20), c3 int, c4 double, c5 time, c6 date, c7 TIMESTAMP,c8 bit, c9 numeric(13,4),c10 clob, c11 blob, c12 enum('Yes', 'No', 'Cancel'));
EOD;
...
printf("#####correct bind#####\n");
$req = cubrid_prepare($conn, 'INSERT INTO prepare_tb(c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
