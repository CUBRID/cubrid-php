...
cubrid_execute($conn,"insert into fetch_arrary_tb(c5,c6,c7,c8,c9) values(TIME '00:00:00', DATE '2008-10-31',TIMESTAMP '10/31',B'1',513254.3143513)");
...
Warning: cubrid_fetch_array() expects parameter 2 to be long, string given in %s on line %d
[002] [0] 
